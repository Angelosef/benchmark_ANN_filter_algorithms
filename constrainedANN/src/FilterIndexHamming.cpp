...
FilterIndex::FilterIndex(float* data, size_t d_, size_t nb_, size_t nc_, vector<vector<string>>properties_, string algo, int mode){
    // In your Constructor or Header initialization:
    dataset_reordered = nullptr;
    data_norms = nullptr;
    data_norms_reordered = nullptr;
    properties_reordered = nullptr;
    Lookup = nullptr;
    counts = nullptr;
    maxMC = nullptr;
    neighbor_set = nullptr;
    clusterAlgo = nullptr;
...
FilterIndex::~FilterIndex() {
    delete clusterAlgo;
    delete[] dataset_reordered;
    delete[] data_norms_reordered;
    delete[] properties_reordered;
    delete[] Lookup;
    delete[] counts;
    delete[] maxMC;
    delete[] neighbor_set;
    // DO NOT delete dataset (it belongs to Python)
}
